...
function LoginForm(){
   ...
   async function onSubmit(data: FormData):Promise<void>{
    ...
    return <div
    className="flex flex-col items-center text-center flex-1 justify-around">
        <h1 className="text-5xl font-bold text-center">Government Portal Login</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="min-h-1/2 w-1/3 h-fit">
            <div className="flex flex-col items-center px-4 py-2 gap-2 h-full w-full justify-around text-lg ring-2 ring-neutral-400 shadow-2xl rounded-lg bg-white">
                ...
                <button
                type="submit"
                className="cursor-pointer mx-8 flex items-center text-white bg-fuchsia-900 py-2 px-12 rounded-full ring-fuchsia-950"
                >Login</button>
                <button
                type="button"
